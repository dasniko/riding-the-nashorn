...
It supports and implements the http://www.ecma-international.org/ecma-262/5.1/[ECMAScript 5.1 specification] and competes among others directly with https://developers.google.com/v8/[Google V8] (the script engine behind https://nodejs.org[Node.js]).
...
IMPORTANT: Nashorn in JDK 8 implements, as mentioned above, the ECMAScript 5.1 specification. But it's Nashorn's strategy to follow the ECMAScript spec.
